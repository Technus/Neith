...
namespace NeithDevices.iss
{
    ...
    public partial class UsbISS : CSSSC.CSSSC
    {
        ...
        public Version ReadVersion()
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_VER);
                byte[] x = Read(3);
        ...
        public string ReadSerialNumber()
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.GET_SER_NUM);
                string serial = Encoding.UTF8.GetString(Read(8));
            ...
            TypeIO io3 = TypeIO.DIGITAL_INPUT, TypeIO io4 = TypeIO.DIGITAL_INPUT)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, Mode.IO_CHANGE, val);
            ...
            TypeIO io3 = TypeIO.DIGITAL_INPUT, TypeIO io4 = TypeIO.DIGITAL_INPUT)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, Mode.IO, val);
                return ReadByte() == 0xFF && ReadByte() == 0x00;
            }
            catch (TimeoutException)
            {
        ...
        public bool WriteModeSerial(int baudRate=9600, TypeIO io3 = TypeIO.DIGITAL_INPUT, TypeIO io4 = TypeIO.DIGITAL_INPUT)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, Mode.SERIAL, (byte)((baudRate >> 8) & 0xff), (byte)(baudRate & 0xFF), val);
                return ReadByte() == 0xFF && ReadByte() == 0x00;
            }
            catch (TimeoutException)
            {
        ...
        public bool WriteModeI2C(ModeI2C i2c=ModeI2C.I2C_S_100KHZ, TypeIO io1 = TypeIO.DIGITAL_INPUT, TypeIO io2 = TypeIO.DIGITAL_INPUT)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, i2c, val);
                return ReadByte() == 0xFF && ReadByte() == 0x00;
            }
            catch (TimeoutException)
            {
        ...
        public bool WriteModeSerialI2C(int baudRate=9600, ModeI2C i2c=ModeI2C.I2C_H_100KHZ)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, (byte)i2c|(byte)Mode.SERIAL, (byte)((baudRate >> 8) & 0xff), (byte)(baudRate & 0xFF));
                return ReadByte() == 0xFF && ReadByte() == 0x00;
            }
            catch (TimeoutException)
            {
        ...
        public bool WriteModeSPI(ModeSPI spi=ModeSPI.SPI_MODE_TX_ACTIVE_TO_IDLE_LOW,int sckFrequency=500000)
        {
            ...
            {
                DiscardInBuffer();
                Write(CommandPrefixISS.USB_ISS, CommandISS.ISS_MODE, spi,(byte)sckFrequency);
                return ReadByte() == 0xFF && ReadByte() == 0x00;
            }
            catch (TimeoutException)
            {
